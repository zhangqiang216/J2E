  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">delete</th>
        
        <th align="center" valign="middle">操作</th>
      </tr>
      <c:forEach items="${orderlist }" var="order2">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="center" valign="middle" class="borderright borderbottom">${order2.orderId }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${order2.userId }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${order2.orderTime}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${order2.orderState }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${order2.delete }</td>
