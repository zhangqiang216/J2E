			...
			<div class="single-grids">				
				<div class="col-md-4 single-grid">		
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="${cake.cakeImageUrl }">
								<div class="thumb-image"> <img src="${cake.cakeImageUrl }" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="${cake.cakeImageUrl }">
								 <div class="thumb-image"> <img src="${cake.cakeImageUrl }" data-imagezoom="true" class="img-responsive"> </div>
							</li>
				...
				<div class="col-md-4 single-grid simpleCart_shelfItem">		
					...
					<div class="galry">
						<div class="prices">
							<h5 class="item_price">${cake.cakePrice }</h5>
						</div>
						<div class="rating">
							<span>☆</span>
							<span>☆</span>
					...
					<form action="MakeOrderServlet?cakeId=${cake.cakeId }" method="post">
					<p class="qty"> Qty :  </p><input min="1" type="number" id="quantity" name="number" value="1" class="form-control input-small">
					<div class="btn_form">
						<%-- <input type="submit" class="add-cart item_add" name="remark" value="add"/>--%>
						<input type="submit" class="add-cart item_add" name="remark" value="Direct purchase"/>
