...
/**
 * Servlet implementation class TypeCakeServlet
 */
@WebServlet("/TypeCakeServlet")
public class TypeCakeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TypeCakeServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String b=request.getParameter("TypeValue");
		...
		page.setColumnCount(cakeDao.getTypeCount(a,b));
		...
		subCakeList=cakeDao.getCakeByType(a,b,fromIndex, count);
